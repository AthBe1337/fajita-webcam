...
const emit = defineEmits([
  ...
  'screenshot', 'record', 'fullscreen', 'toggle-panel',
])
...
<template>
  <div class="toolbar">
    ...
    <button class="tbtn desktop-only" :class="{ active: flipV }" @click="emit('flip-v')" title="Flip V (V)">
    ...
    <!-- Zoom -->
    <button class="tbtn desktop-only" @click="emit('zoom-out')" title="Zoom Out (-)">
    ...
    <button class="tbtn desktop-only" @click="emit('zoom-in')" title="Zoom In (+)">
    ...
    <!-- Settings -->
    <button class="tbtn fullscreen-btn desktop-only" @click="emit('fullscreen')" title="Fullscreen (F)">
...
.zoom-badge:hover, .rot-badge:hover {
  background: var(--bg-elevated);
  color: var(--text-primary);
}
